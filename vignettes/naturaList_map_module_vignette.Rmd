...
```{r openMapModule, eval=FALSE, echo=TRUE}
...
![Fig. 2 - Draw polygon tool from `map_module()` function used in the example with Alsophila setosa occurrence data. In this example, the points inside the blue polygon were deleted.](../vignettes/draw_polygon.png)
